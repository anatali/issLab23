    ...
    protected void paintComponent(java.awt.Graphics g)
    {
        ...
        switch(numberSystem)
        {
            case HEX:
                ...
                G2.drawString(Integer.toHexString((int)value).toUpperCase(), (int) ((lcdImage.getWidth() - UNIT_STRING_WIDTH - VALUE_BOUNDARY.getWidth()) - lcdImage.getWidth() * 0.09), (int) (lcdImage.getHeight() * 0.76f));
                break;
                
            case OCT:
                valueLayout = new java.awt.font.TextLayout(Integer.toOctalString((int)value), G2.getFont(), RENDER_CONTEXT);
                VALUE_BOUNDARY.setFrame(valueLayout.getBounds());
                G2.drawString(Integer.toOctalString((int)value), (int) ((lcdImage.getWidth() - UNIT_STRING_WIDTH - VALUE_BOUNDARY.getWidth()) - lcdImage.getWidth() * 0.09), (int) (lcdImage.getHeight() * 0.76f));
                break;
