...
//                });
    ...
    protected java.awt.image.BufferedImage create_FRAME_Image(final int WIDTH)
    {
        ...
        {
            case ROUND:
                return FRAME_FACTORY.createRadialFrame(WIDTH, getFrameDesign(), getCustomFrameDesign(), getFrameEffect());                
            case SQUARE:
                return FRAME_FACTORY.createLinearFrame(WIDTH, getFrameDesign(), getCustomFrameDesign(), getFrameEffect());
            default:
                return FRAME_FACTORY.createRadialFrame(WIDTH, getFrameDesign(), getCustomFrameDesign(), getFrameEffect());
        }
    }
    ...
    protected java.awt.image.BufferedImage create_POSTS_Image(final int WIDTH, java.awt.image.BufferedImage image, final eu.hansolo.steelseries.tools.PostPosition... POSITIONS)
    {
        ...
        final java.awt.image.BufferedImage SINGLE_POST = create_KNOB_Image((int) Math.ceil(WIDTH * 0.03738316893577576), eu.hansolo.steelseries.tools.KnobType.SMALL_STD_KNOB, getModel().getKnobStyle());
        
        java.util.List<eu.hansolo.steelseries.tools.PostPosition> postPositionList = java.util.Arrays.asList(POSITIONS);

        // Draw center knob
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.CENTER))
        {       
            switch (getKnobType())
            {
                case SMALL_STD_KNOB:                    
        ...
        // Draw min bottom
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.MIN_BOTTOM))
        {
            G2.drawImage(SINGLE_POST, (int) (IMAGE_WIDTH * 0.336448609828949), (int) (IMAGE_HEIGHT * 0.8037382960319519), null);           
        }

        // Draw max bottom post
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.MAX_BOTTOM))
        {
        ...
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.MAX_CENTER_BOTTOM))
        {
        ...
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.MAX_CENTER_TOP))
        {
            G2.drawImage(SINGLE_POST, (int) (IMAGE_WIDTH * 0.5233644843101501), (int) (IMAGE_HEIGHT * 0.13084112107753754), null);
        }

        // Draw max right post
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.MAX_RIGHT))
        {
            G2.drawImage(SINGLE_POST, (int) (IMAGE_WIDTH * 0.8317757248878479), (int) (IMAGE_HEIGHT * 0.514018714427948), null);
        }

        // Draw min left post
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.MIN_LEFT))
        {
        ...
        final java.awt.geom.Point2D KNOB_CENTER = new java.awt.geom.Point2D.Double();
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.LOWER_CENTER))
        {            
            switch (getKnobType())
            {                
                case SMALL_STD_KNOB:                                
                    ...
                    {
                        case BLACK:
                            LOWERCENTER_KNOB_MAIN_COLORS = new java.awt.Color[]
                            {
                                new java.awt.Color(0xBFBFBF),
                                new java.awt.Color(0x2B2A2F),
                                new java.awt.Color(0x7D7E80)
                ...
                case BIG_STD_KNOB:
                    ...
                    {
                        case BLACK:
                            BIGLOWERCENTER_BACKGROUNDFRAME_COLORS = new java.awt.Color[]
                            {
                                new java.awt.Color(129, 133, 136, 255),
                                new java.awt.Color(61, 61, 73, 255)
                            };
                    ...
                    {
                        case BLACK:
                            BIGLOWERCENTER_BACKGROUND_COLORS = new java.awt.Color[]
                            {
                                new java.awt.Color(26, 27, 32, 255),
                                new java.awt.Color(96, 97, 102, 255)
                            };
                    ...
                    {
                        case BLACK:
                            BIGLOWERCENTER_FOREGROUNDFRAME_COLORS = new java.awt.Color[]
                            {
                                new java.awt.Color(191, 191, 191, 255),
                                new java.awt.Color(56, 57, 61, 255),
                                new java.awt.Color(143, 144, 146, 255)
                    ...
                    {
                        case BLACK:
                            BIGLOWERCENTER_FOREGROUND_COLORS = new java.awt.Color[]
                            {
                                new java.awt.Color(191, 191, 191, 255),
                                new java.awt.Color(94, 93, 99, 255),
                                new java.awt.Color(43, 42, 47, 255),
                ...
                case METAL_KNOB:
                    final java.awt.geom.Ellipse2D METALKNOBLC_FRAME = new java.awt.geom.Ellipse2D.Double(IMAGE_WIDTH * 0.4579439163208008, IMAGE_HEIGHT * 0.6915887594223022, IMAGE_WIDTH * 0.08411216735839844, IMAGE_HEIGHT * 0.08411216735839844);
                    switch (getOrientation())
                    {
                        case WEST:
                    ...
                    final java.awt.geom.Point2D METALKNOBLC_FRAME_START = new java.awt.geom.Point2D.Double(0, METALKNOBLC_FRAME.getBounds2D().getMinY() );
                    final java.awt.geom.Point2D METALKNOBLC_FRAME_STOP = new java.awt.geom.Point2D.Double(0, METALKNOBLC_FRAME.getBounds2D().getMaxY() );
                    ...
                    final java.awt.Color[] METALKNOBLC_FRAME_COLORS = 
                    {
                        new java.awt.Color(92, 95, 101, 255),
                        new java.awt.Color(46, 49, 53, 255),
                        new java.awt.Color(22, 23, 26, 255)
                    };
                    final java.awt.LinearGradientPaint METALKNOBLC_FRAME_GRADIENT = new java.awt.LinearGradientPaint(METALKNOBLC_FRAME_START, METALKNOBLC_FRAME_STOP, METALKNOBLC_FRAME_FRACTIONS, METALKNOBLC_FRAME_COLORS);
                    G2.setPaint(METALKNOBLC_FRAME_GRADIENT);
                    G2.fill(METALKNOBLC_FRAME);

                    final java.awt.geom.Ellipse2D METALKNOBLC_MAIN = new java.awt.geom.Ellipse2D.Double(IMAGE_WIDTH * 0.46261683106422424, IMAGE_HEIGHT * 0.6962617039680481, IMAGE_WIDTH * 0.0747663676738739, IMAGE_HEIGHT * 0.07476633787155151);
                    final java.awt.geom.Point2D METALKNOBLC_MAIN_START = new java.awt.geom.Point2D.Double(0, METALKNOBLC_MAIN.getBounds2D().getMinY() );
                    final java.awt.geom.Point2D METALKNOBLC_MAIN_STOP = new java.awt.geom.Point2D.Double(0, METALKNOBLC_MAIN.getBounds2D().getMaxY() );
                    final float[] METALKNOBLC_MAIN_FRACTIONS = 
                    {
                        0.0f,
                        1.0f
                    };
                    final java.awt.Color[] METALKNOBLC_MAIN_COLORS;
                    switch (getModel().getKnobStyle())
                    {
                        case BLACK:
                            METALKNOBLC_MAIN_COLORS = new java.awt.Color[] 
                            {
                                new java.awt.Color(0x2B2A2F),
                                new java.awt.Color(0x1A1B20)
                            };
                    ...
                    final java.awt.LinearGradientPaint METALKNOBLC_MAIN_GRADIENT = new java.awt.LinearGradientPaint(METALKNOBLC_MAIN_START, METALKNOBLC_MAIN_STOP, METALKNOBLC_MAIN_FRACTIONS, METALKNOBLC_MAIN_COLORS);
                    G2.setPaint(METALKNOBLC_MAIN_GRADIENT);
                    G2.fill(METALKNOBLC_MAIN);

                    final java.awt.geom.GeneralPath METALKNOBLC_LOWERHL = new java.awt.geom.GeneralPath();
                    METALKNOBLC_LOWERHL.setWindingRule(java.awt.geom.GeneralPath.WIND_EVEN_ODD);
                    ...
                    final java.awt.geom.Point2D METALKNOBLC_LOWERHL_CENTER = new java.awt.geom.Point2D.Double( (0.5 * IMAGE_WIDTH), (0.7710280373831776 * IMAGE_HEIGHT) );
                    final float[] METALKNOBLC_LOWERHL_FRACTIONS = 
                    {
                        0.0f,
                        1.0f
                    };
                    final java.awt.Color[] METALKNOBLC_LOWERHL_COLORS = 
                    {
                        new java.awt.Color(255, 255, 255, 153),
                        new java.awt.Color(255, 255, 255, 0)
                    };
                    final java.awt.RadialGradientPaint METALKNOBLC_LOWERHL_GRADIENT = new java.awt.RadialGradientPaint(METALKNOBLC_LOWERHL_CENTER, (float)(0.03271028037383177 * IMAGE_WIDTH), METALKNOBLC_LOWERHL_FRACTIONS, METALKNOBLC_LOWERHL_COLORS);
                    G2.setPaint(METALKNOBLC_LOWERHL_GRADIENT);
                    G2.fill(METALKNOBLC_LOWERHL);

                    final java.awt.geom.GeneralPath METALKNOBLC_UPPERHL = new java.awt.geom.GeneralPath();
                    METALKNOBLC_UPPERHL.setWindingRule(java.awt.geom.GeneralPath.WIND_EVEN_ODD);
                    ...
                    final java.awt.geom.Point2D METALKNOBLC_UPPERHL_CENTER = new java.awt.geom.Point2D.Double( (0.4953271028037383 * IMAGE_WIDTH), (0.6915887850467289 * IMAGE_HEIGHT) );
                    final float[] METALKNOBLC_UPPERHL_FRACTIONS = 
                    {
                        0.0f,
                        1.0f
                    };
                    final java.awt.Color[] METALKNOBLC_UPPERHL_COLORS = 
                    {
                        new java.awt.Color(255, 255, 255, 191),
                        new java.awt.Color(255, 255, 255, 0)
                    };
                    final java.awt.RadialGradientPaint METALKNOBLC_UPPERHL_GRADIENT = new java.awt.RadialGradientPaint(METALKNOBLC_UPPERHL_CENTER, (float)(0.04906542056074766 * IMAGE_WIDTH), METALKNOBLC_UPPERHL_FRACTIONS, METALKNOBLC_UPPERHL_COLORS);
                    G2.setPaint(METALKNOBLC_UPPERHL_GRADIENT);
                    G2.fill(METALKNOBLC_UPPERHL);

                    final java.awt.geom.Ellipse2D METALKNOBLC_INNERFRAME = new java.awt.geom.Ellipse2D.Double(IMAGE_WIDTH * 0.47663551568984985, IMAGE_HEIGHT * 0.7149532437324524, IMAGE_WIDTH * 0.04205608367919922, IMAGE_HEIGHT * 0.04205608367919922);
                    final java.awt.geom.Point2D METALKNOBLC_INNERFRAME_START = new java.awt.geom.Point2D.Double(0, METALKNOBLC_INNERFRAME.getBounds2D().getMinY() );
                    final java.awt.geom.Point2D METALKNOBLC_INNERFRAME_STOP = new java.awt.geom.Point2D.Double(0, METALKNOBLC_INNERFRAME.getBounds2D().getMaxY() );
                    final float[] METALKNOBLC_INNERFRAME_FRACTIONS = 
                    {
                        0.0f,
                        1.0f
                    };
                    final java.awt.Color[] METALKNOBLC_INNERFRAME_COLORS = 
                    {
                        new java.awt.Color(0, 0, 0, 255),
                        new java.awt.Color(204, 204, 204, 255)
                    };
                    final java.awt.LinearGradientPaint METALKNOBLC_INNERFRAME_GRADIENT = new java.awt.LinearGradientPaint(METALKNOBLC_INNERFRAME_START, METALKNOBLC_INNERFRAME_STOP, METALKNOBLC_INNERFRAME_FRACTIONS, METALKNOBLC_INNERFRAME_COLORS);
                    G2.setPaint(METALKNOBLC_INNERFRAME_GRADIENT);
                    G2.fill(METALKNOBLC_INNERFRAME);

                    final java.awt.geom.Ellipse2D METALKNOBLC_INNERBACKGROUND = new java.awt.geom.Ellipse2D.Double(IMAGE_WIDTH * 0.4813084006309509, IMAGE_HEIGHT * 0.7196261882781982, IMAGE_WIDTH * 0.03271031379699707, IMAGE_HEIGHT * 0.032710254192352295);
                    final java.awt.geom.Point2D METALKNOBLC_INNERBACKGROUND_START = new java.awt.geom.Point2D.Double(0, METALKNOBLC_INNERBACKGROUND.getBounds2D().getMinY() );
                    final java.awt.geom.Point2D METALKNOBLC_INNERBACKGROUND_STOP = new java.awt.geom.Point2D.Double(0, METALKNOBLC_INNERBACKGROUND.getBounds2D().getMaxY() );
                    final float[] METALKNOBLC_INNERBACKGROUND_FRACTIONS = 
                    {
                        0.0f,
                        1.0f
                    };
                    final java.awt.Color[] METALKNOBLC_INNERBACKGROUND_COLORS = 
                    {
                        new java.awt.Color(1, 6, 11, 255),
                        new java.awt.Color(50, 52, 56, 255)
                    };
                    final java.awt.LinearGradientPaint METALKNOBLC_INNERBACKGROUND_GRADIENT = new java.awt.LinearGradientPaint(METALKNOBLC_INNERBACKGROUND_START, METALKNOBLC_INNERBACKGROUND_STOP, METALKNOBLC_INNERBACKGROUND_FRACTIONS, METALKNOBLC_INNERBACKGROUND_COLORS);
        ...
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.SMALL_GAUGE_MAX_RIGHT))
        {
            switch (getOrientation())
            {
                case WEST:
        ...
        if (postPositionList.contains(eu.hansolo.steelseries.tools.PostPosition.SMALL_GAUGE_MIN_LEFT))
        {
            switch (getOrientation())
            {
                case WEST:
     ...
     */
    private java.awt.image.BufferedImage create_KNOB_Image(final int WIDTH, final eu.hansolo.steelseries.tools.KnobType KNOB_TYPE, final eu.hansolo.steelseries.tools.KnobStyle KNOB_STYLE)
    {
    ...
    protected java.awt.image.BufferedImage create_THRESHOLD_Image(final int WIDTH, final double ROTATION_OFFSET)
    {
        ...
        final java.awt.geom.Point2D THRESHOLD_START = new java.awt.geom.Point2D.Double();
        final java.awt.geom.Point2D THRESHOLD_STOP = new java.awt.geom.Point2D.Double();
