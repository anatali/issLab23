...
//protected static Hashtable<String, ProxyAsClient> proxyMap = new Hashtable<String, ProxyAsClient>();
/*
//Il controllo su un proxy per contesto viene fatto in ActorContext23
	public static ProxyAsClient create(String name, String host, String entry, ProtocolType protocol){
		ProxyAsClient prxy = proxyMap.get(name+host+entry);
		if( prxy != null ) return prxy;
		else return new ProxyAsClient(name,host,entry,protocol);
	}*/
/*
