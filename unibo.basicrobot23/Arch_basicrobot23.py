...
with Diagram('basicrobot23Arch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
     ...
     with Cluster('ctxbasicrobot', graph_attr=nodeattr):
          ...
          robotposclient=Custom('robotposclient','./qakicons/symActorSmall.png')
     ...
     planexec >> Edge(color='magenta', style='solid', xlabel='checkowner', fontcolor='magenta') >> engager
     ...
     robotposendosimbiotico >> Edge(color='magenta', style='solid', xlabel='checkowner', fontcolor='magenta') >> engager
     robotposendosimbiotico >> Edge(color='magenta', style='solid', xlabel='doplan', fontcolor='magenta') >> basicrobot
     robotposclient >> Edge(color='magenta', style='solid', xlabel='engage', fontcolor='magenta') >> basicrobot
     robotposclient >> Edge(color='magenta', style='solid', xlabel='moverobot', fontcolor='magenta') >> basicrobot
     robotposclient >> Edge(color='magenta', style='solid', xlabel='getrobotstate', fontcolor='magenta') >> basicrobot
diag
