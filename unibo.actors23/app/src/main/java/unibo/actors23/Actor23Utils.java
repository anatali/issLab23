...
public static boolean trace = false;
    ...
    public static ActorContext23 createTheContext(String ctx, String hostName ) throws Exception {
        ...
        } else{  CommUtils.outred(pfx+"Actor23Utils | createContext for different "  ); }
        return newctx;
    }
        ...
        try {
            ...
            while( iter.hasNext() ){
                ...
                if ( solve("qactor( "+ actorName + "," + ctx.name + ", _ )" ) ){
                    ...
                    if(trace) CommUtils.outgray(pfx+"Actor23Utils | setTheActorsRemote in " + ctx.name + " found: "+ actorName );
    ...
    public static void createActorsOfContext(ActorContext23 ctx){
        try {
            //if(trace) CommUtils.outgray(pfx+"Actor23Utils | createTheActors in:"+ ctx.name );
            ...
            CommUtils.outred(pfx+"Actor23Utils | createTheActorsInContext ERROR " +e.getMessage());
        }
