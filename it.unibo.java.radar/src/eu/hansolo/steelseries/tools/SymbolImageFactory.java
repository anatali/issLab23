...
public enum SymbolImageFactory
{
    ...
    private final eu.hansolo.steelseries.tools.Shadow SHADOW = eu.hansolo.steelseries.tools.Shadow.INSTANCE;
    private int widthBuffer = 0;
    private eu.hansolo.steelseries.tools.SymbolType symbolTypeBuffer = eu.hansolo.steelseries.tools.SymbolType.HORN;
    private eu.hansolo.steelseries.tools.ColorDef symbolColorBuffer = null;
    private eu.hansolo.steelseries.tools.CustomColorDef customSymbolColorBuffer = new eu.hansolo.steelseries.tools.CustomColorDef(java.awt.Color.RED);    
    private java.awt.image.BufferedImage symbolImageBuffer = UTIL.createImage(1, 1, java.awt.Transparency.TRANSLUCENT);
    private java.awt.image.BufferedImage clipImageSymbol = UTIL.createImage(1, 1, java.awt.Transparency.TRANSLUCENT);;
     ...
     */
    public java.awt.image.BufferedImage createSymbol(final int WIDTH, final eu.hansolo.steelseries.tools.SymbolType SYMBOL_TYPE, final eu.hansolo.steelseries.tools.ColorDef SYMBOL_COLOR, final eu.hansolo.steelseries.tools.CustomColorDef CUSTOM_SYMBOL_COLOR, final boolean GLOW)
    {        
        if (WIDTH <= 0)
        {
        ...
        symbolImageBuffer = UTIL.createImage(WIDTH, WIDTH, java.awt.Transparency.TRANSLUCENT);
        final java.awt.Graphics2D G2 = symbolImageBuffer.createGraphics();
        ...
        final java.awt.geom.GeneralPath SYMBOL;        

        switch (SYMBOL_TYPE)
        {            
            case FUEL:
                SYMBOL = new java.awt.geom.GeneralPath();
                SYMBOL.setWindingRule(java.awt.geom.GeneralPath.WIND_EVEN_ODD);
        ...
        final java.awt.Color STROKE_COLOR;
        final java.awt.Color FILL_COLOR;
        final java.awt.Color GLOW_COLOR;        
        if (SYMBOL_COLOR == eu.hansolo.steelseries.tools.ColorDef.CUSTOM && CUSTOM_SYMBOL_COLOR != null)
        {
