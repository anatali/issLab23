...
public   class ActorBasicFsm23Old extends ActorBasic23 {
    ...
    public ActorBasicFsm23Old(String name, ActorContext23 ctx) {
        super(name, ctx);
        declareTheStates( );
    ...
    protected void doDeclareState(ActorBasicFsm23Old castMyself,    //Since Lenzi guards as methods
